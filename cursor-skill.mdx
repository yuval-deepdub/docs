...
curl -o .cursor/skills/deepdub-api/SKILL.md \
  https://raw.githubusercontent.com/yuval-deepdub/docs/main/skills/deepdub-api-SKILL.md
```

Or manually create `.cursor/skills/deepdub-api/SKILL.md` with the content from the **Skill file** section below.
