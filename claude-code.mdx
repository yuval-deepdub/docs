...
Place an `AGENTS.md` file at the root of your repository:

```bash
curl -o AGENTS.md \
  https://raw.githubusercontent.com/yuval-deepdub/docs/main/skills/deepdub-AGENTS.md
```

Or manually create `AGENTS.md` with the content from the **AGENTS.md file** section below.
