...
The REST API returns audio as raw bytes in the response body. Supported formats:
...
|---------|----------|---------------|
| **Delivery** | Complete audio in a single HTTP response | Chunked audio delivered incrementally as base64-encoded messages |
